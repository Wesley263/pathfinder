 ...
 * 基于规则的意图分类器。
 *
 * 通过关键词、别名和示例命中叠加启发式规则，为意图树叶子节点打分。
 */
@Service
